...
const renderDetailsButton = (params) => {
  ...
  const renderLogo = (params) => {
    ...
    return (
      <div style={{backgroundColor:params.row.rgba,height:'50px',width:'50px'}}></div>
  ...
  const columns = [
    ...
    {field: 'rgba',headerName: 'Logo',width: 120,renderCell:renderLogo},
...
// ----------------------------------------
  ...
  // detecta si el state data se encuentra con Data,para renderizar la tabla
  useEffect(() => {
    // alert('data')
    if(data.length>0){
      // alert('data full')
  ...
  return (
    <>
      ...
      {renderTabla?
      <>
        <h3 style={{color:'black'}}>COLORES</h3>
