...
import {Select,getAvatarTabla,actualizarUrls,Delete,DeletePermanente} from './service/index.js'
...
import DataTable from '../../components/Tabla/Tabla.jsx';
...
// renderizado de botones en la tabla
  ...
  const columns = [
    ...
    {field: 'img_url',headerName: 'Logo',width: 70,renderCell:renderLogo},
    { field: 'productos', headerName: 'Producto', width: 210 },
    { field: 'precios', headerName: 'Precio', width: 60 },
    { field: 'cantidad', headerName: 'Unidades', width: 60 },
    { field: 'categorias', headerName: 'Categoria', width: 100 },
    { field: 'clasificacion', headerName: 'Clasificacion', width: 100 },
    { field: 'generos', headerName: 'Genero', width: 70 },
    { field: 'usos', headerName: 'Uso', width: 90 },
    { field: 'colores', headerName: 'Color', width: 50 },
    { field: 'tallas', headerName: 'Talla', width: 20 },
    {field: 'status',headerName: 'Status',width: 20,},
    {field: 'acciones',headerName: 'Acciones',width: 230,renderCell:renderDetailsButton},
  ];
