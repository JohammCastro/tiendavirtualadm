...
import {Select,Delete,getAvatarTabla,actualizarUrls,DeletePermanente} from './service'
...
export function TpCategorias() {
  ...
  const [urlAvatar, setUrlAvatar] = useState("https://i.gifer.com/origin/34/34338d26023e5515f6cc8969aa027bca.gif")
...
const renderLogo = (params) => {
  ...
  const actualizarTabla=()=>{
    // alert('actualizar tabla categoria')
...
const actLogo=()=>{
  ...
  return (
    <>
      ...
      {renderTabla?
      <>
        <h3 style={{color:'black'}}>CATEGORIAS</h3>
